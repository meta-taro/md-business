...
デスクトップの 0.22.0 と Chrome 拡張の 0.6.0 は、同じものの新旧ではなく別々のものを指す。

変更の中身は、配布物ごとの履歴に書いてある。

| 配布物 | 版 | 入手先 | 変更履歴 |
| --- | --- | --- | --- |
| デスクトップアプリ | 0.22.0 | [ダウンロード](https://meta-taro.github.io/md-business/download/) | [apps/desktop/CHANGELOG.md](apps/desktop/CHANGELOG.md) |
