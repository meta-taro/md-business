...
| v0.8.0 | 2026-08〜 | + `schema-api-spec`（API 設計書 — 詳細設計対応可）/ `schema-db-spec`（**RDB** 設計書、型プルダウン）/ `schema-nosql-db-spec`（**NoSQL** 設計書 — document/key-value/graph、partition key、access pattern 表、index 設計を扱う、優先度低、PdM 指示 2026-06-18） |
