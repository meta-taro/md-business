...
| v0.4.0 | 2026-06-17（zip 生成中・PdM 提出待ち） | + `schema-spec`（基本設計書）+ 画像 / SVG / DOMPurify サニタイザ + 免税事業者モード + popup 適格/免税分岐 UX（Mermaid は CSP 違反で延期） |
| v0.5.0+ | 2026-06-18〜 | + 請求書実務細部（振込手数料 / 締日 / 端数処理）+ Mermaid 代替手段 |
