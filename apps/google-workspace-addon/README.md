...
| 同期 | ローカル .md にのみ書き戻し | Sheets-as-truth: サイドバーの「GitHub に push」ボタン → GitHub Contents API で md commit |
...
pnpm dlx @google/clasp push               # dist/ の Code.js / appsscript.json / Sidebar.html を Apps Script へ送信
